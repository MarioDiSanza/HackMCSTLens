...
function update(eventData)
{
   ...
   {
        script.rainMaterial.mainPass.timeLifeMinMax = vec2.lerp(new vec2(0.5,1.5), new vec2(1.5,1.5), script.rainIntensity);
   }

   if(script.splashMaterial != null)
   {
        script.splashMaterial.mainPass.spawnMaxParticles = lerp(100.0, 1000.0, script.rainIntensity);
        script.splashMaterial.mainPass.timeLifeMinMax = vec2.lerp(new vec2(0.5,1.5), new vec2(0.5,0.5), script.rainIntensity);
   }    
}
